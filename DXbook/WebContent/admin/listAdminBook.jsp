...
<body>
	<div style="margin-left: 2px;margin-top: 2px;">
    	<h3 style="margin-left: 50px;">我的书籍</h3>
    	<table border="1px" cellspacing="0" bordercolor="#eeddee" style="text-align: center;">
    	    	<tr>
    				...
    				<td width="80px">操作1</td>
    				<td width="80px">操作2</td>
    			</tr>
    		<c:forEach var="book" items="${bookList}" varStatus="status">
    	    	<tr>
    				...
    				<td><a href="BookAction!updateBook?book.bookId=${book.bookId}">修改</a></td>
    				<td><a href="BookAction!deleteBook?book.bookId=${book.bookId}">删除</a></td>
    			</tr>
    		</c:forEach>
    		    <tr>
    				<td colspan="12" style="text-align: center;">
		    			<a href="BookAction!listAdminBook?currentPage=1">首页</a>&nbsp;
		    			<a href="BookAction!listAdminBook?currentPage=${page.currentPage<=1 ? 1:(page.currentPage-1)}">上一页</a>&nbsp;
		    			<a href="BookAction!listAdminBook?currentPage=${page.currentPage>=page.pageSum ? (page.pageSum):(page.currentPage+1)}">下一页</a>&nbsp;
		    			<a href="BookAction!listAdminBook?currentPage=${page.pageSum}">尾页</a>
