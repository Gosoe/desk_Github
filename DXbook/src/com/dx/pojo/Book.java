...
public class Book {
	...
	public Book(int bookId, int userId, String name, String author, String bookType, String brief, int storage,
			float costPrice, float nowPrice, String imgPath, String isSold, String recommendation,
